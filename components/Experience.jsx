    ...
    <Layout section="experience">
      ...
      <div className="flex overflow-x-scroll md:overflow-visible scrollbar-hide gap-4  px-4 md:px-0 py-4">
        {ExperienceData.map((data) => {
          return (
            <div key={data.id} className="flex flex-shrink-0 md:flex-shrink rounded-lg bg-white dark:bg-black dark:outline-zinc-900 dark:outline shadow-lg w-[320px] flex-col px-4 py-6 hover:scale-[1.03] duration-500 ease-in-out">
